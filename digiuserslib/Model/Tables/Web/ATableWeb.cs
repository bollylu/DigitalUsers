...
public abstract class ATableWeb<T> : ATableCache<T> where T : IRecord {
  ...
  protected ATableWeb(string dataSourceUri) : this() {
    DataSourceUri = new Uri(dataSourceUri);
  }
  protected ATableWeb(Uri dataSourceUri) : this() {
